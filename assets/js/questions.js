...
playerNick === null ? window.location.href = "startquiz.html" : playerNick;
...
let questions = [
	...
	{
		id: 2,
		question: `${playerNick}, a respeito da leitura, selecione a resposta que você se indentifica.`,
		answers: [
			{
				id: 1,
				effect: 10,
