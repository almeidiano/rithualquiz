var playerNick = localStorage.getItem("playerNick");
playerNick == undefined || null ? playerNick = 'Visitante' : playerNick;

let questions: Array<{id: number, question: string, answers: Array<{id: number, characteristic: string, answer: String}>}> = [
	{
		id: 1,
